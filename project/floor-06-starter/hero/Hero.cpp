...
// hero/Hero.cpp — printLog is now a template in Hero.h. This file keeps
// the loaders and printInventory; the two old printLog functions are
// gone, replaced by one templated `printLog<It>(first, last, n, label, total)`.
