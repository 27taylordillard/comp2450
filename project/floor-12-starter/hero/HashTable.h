...
// the rehash driver are all filled in here. It ships finished so this floor's
// code can use it, and so the Graph you build this week can sit beside it as the
// last of the five independent indexes (Bag, BST, Registry, HashTable, Graph).
//
...
// BST<Monster> (Floor 9), and Registry (Floor 10) — and now the Graph (Floor 12)
// — nothing else is touched. `banish`-ing a monster from this table does NOT
